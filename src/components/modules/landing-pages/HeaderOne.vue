    ...
    <div class="container-fluid navbar-inner mt-2">
      <div class="d-flex align-items-center justify-content-between w-100 landing-header">
        <div class="d-flex align-items-center d-xl-none">
          ...
          <router-link to="/landing-page" class="navbar-brand ms-3">
            <!--Logo start-->
        ...
        <ul class="navbar-nav align-items-center navbar-list d-none d-xl-flex">
          ...
          <li class="nav-item"><router-link class="nav-link" active-class="active" to="/contact-us">Contact Us</router-link></li>
        </ul>
      </div>
    </div>
  </nav>
