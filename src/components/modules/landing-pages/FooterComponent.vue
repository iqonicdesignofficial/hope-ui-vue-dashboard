        ...
        <div class="row">
          <div class="col-md-4">
            <a href="/dashboard" class="navbar-brand d-flex align-items-center">
              ...
              <h4 class="logo-title ms-3 text-white">{{ appName }}</h4>
            </a>
            <p class="text-white my-4">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
          ...
          <div class="col-md-4 mt-md-0 mt-4">
            ...
            <div class="input-group mb-4">
              <input type="text" class="form-control input-email ps-0" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" />
              <span class="input-group-text input-email-btn" id="basic-addon1"></span>
            </div>

            <ul class="list-unstyled p-0 m-0 d-flex mt-4">
              <li>
                <router-link to="#"><img src="../../../assets/images/brands/08.png" alt="fb" loading="lazy" class="rounded-pill" /></router-link>
              </li>
              <li class="ps-3">
                <router-link to="#"><img src="../../../assets/images/brands/09.png" alt="gm" loading="lazy" class="rounded-pill" /></router-link>
              </li>
              <li class="ps-3">
                <router-link to="#"><img src="../../../assets/images/brands/10.png" alt="im" loading="lazy" class="rounded-pill" /></router-link>
              </li>
              <li class="ps-3">
                <router-link to="#"><img src="../../../assets/images/brands/13.png" alt="li" loading="lazy" class="rounded-pill" /></router-link>
              </li>
            </ul>
          </div>
          <hr />
      ...
      <div class="container border-top py-4 border-primary">
        <div class="row">
          <div class="col-md-12 text-center text-white">
            <p class="mb-0">© {{ date }} Hope UI, All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </div>
