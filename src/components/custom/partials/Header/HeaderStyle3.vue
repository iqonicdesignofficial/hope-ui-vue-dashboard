<template>
  ...
  <div class="container-fluid navbar-inner">
    <button data-trigger="navbar_main" class="d-lg-none btn btn-primary rounded-pill p-1 pt-0" type="button"  @click="mobileOffcanvas">
      <svg width="20px" height="20px" viewBox="0 0 24 24">
        <path fill="currentColor" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
    </svg>
    </button>
    <router-link :to="{ name: 'default.dashboard'}" class="navbar-brand logo-center col-md-3 col-lg-3 ms-0">
    ...
    <HorizontalNav :showoffcanvas='onshowoffcanvas' @closeoffcanvas="onCloseOffcanvas" />
...
<script>
import HorizontalNav from '@/components/custom/partials/Header/HorizontalNav'
export default {
  name: 'HeaderStyle3',
  components: {
    HorizontalNav
