<template>
  <div class="bd-example">
    <b-button variant="danger" id="popover-target-1">Click to toggle popover</b-button>
  ...
  <div class="bd-example">
    <b-button v-b-popover.hover.top="'Vivamus sagittis lacus vel augue laoreet rutrum faucibus.'">Popover on top</b-button>
    {{ ' ' }}
