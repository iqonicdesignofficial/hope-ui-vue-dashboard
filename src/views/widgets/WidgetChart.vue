      ...
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            ...
            <apexchart height="80" type="area" :series="service2.series" :options="service2.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            ...
            <apexchart height="80" type="area" :series="service3.series" :options="service3.options" />
          </div>
        </b-card>
      </b-col>
      <b-col class="col-sm-6 col-lg-6 col-xl-3">
        <b-card body-class="iq-box-relative">
          <div class="iq-service d-flex align-items-center justify-content-between" style="position: relative">
            ...
            <apexchart height="80" type="area" :series="service4.series" :options="service4.options" />
          </div>
        </b-card>
      </b-col>
        ...
        <div class="col-md-12 col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <apexchart height="80" type="area" :series="chart9.series" :options="chart9.options" />
            </div>
          </div>
        </div>
      </b-col>
        ...
        <b-card>
          <div class="d-flex flex-column">
            ...
            <div class="border rounded">
              <apexchart height="250" type="bar" :series="extrachart.series" :options="extrachart.options" :colorOpt="true" />
            </div>
          </div>
        </b-card>
      </b-col>
