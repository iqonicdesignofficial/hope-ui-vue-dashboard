<template>
  <div class="inner-box">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <BlogDetailWidget :blogImage="require('@/assets/modules/landing-pages/images/blog/01.png')" cardClass="mt-4" blogDate="December 26, 2022" blogTitle="The Cheapest Destinations Of All Time, A List Of Beauty And Budget." blogAuther="Travel" />
        </div>
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <router-link to="#" class="btn btn-primary">Post Comment</router-link>
            </div>
          </div>
        </div>
      </div>
...
<script>
//components
import BlogDetailWidget from '@/components/widgets/BlogDetailWidget.vue'
export default {
  components: {
    BlogDetailWidget
  }
