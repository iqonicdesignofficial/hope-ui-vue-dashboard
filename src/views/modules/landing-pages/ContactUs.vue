<template>
  <SubHeaderWidget subTitle="Contact Us" subBreadcrumb="Contact Us" />
  ...
  <div class="section-padding bg-secondary">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <p class="mb-2 text-uppercase text-white">Contact Us</p>
          <h2 class="text-white mb-4">
            Have any query? <br />
            Get in Touch.
          </h2>
          <img src="../../../assets/modules/landing-pages/images/home-4/contact.webp" alt="{{Id}}" class="img-fluid" loading="lazy" />
        </div>
        <div class="col-md-6 mt-4 mt-md-0">
          ...
          <router-link to="#" class="btn btn-primary">Submit</router-link>
        </div>
      </div>
    </div>
  </div>
